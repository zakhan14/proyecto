...
STATIC_URL = '/static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'static')]  # Para tus archivos originales
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')    # Para los recopilados por collectstatic

# Añade esto para producción:
